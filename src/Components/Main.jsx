...
const Main = () => {
    return (
        <main>
            <div className="grid grid-cols-1 px-[7vh] mt-14 mb-16 md:grid-cols-2 lg:grid-cols-3 gap-24">
                <div className="relative rounded-3xl overflow-hidden shadow-lg shadow-[#FF5C8D]/50 hover:opacity-50 transition cursor-pointer">
